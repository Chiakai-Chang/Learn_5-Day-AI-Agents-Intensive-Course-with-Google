# 紀錄自己學習 **5-Day-AI-Agents-Intensive-Course-with-Google** 的過程
> 免費課程連結: https://www.kaggle.com/learn-guide/5-day-agents

## Day 1 (Introduction to Agents)
- [summary podcast](https://www.youtube.com/watch?v=zTxvGzpfF-g)
- [課程內容](https://www.kaggle.com/whitepaper-introduction-to-agents)
- [Chiakai 產的 AI 簡報+備忘稿](https://chiakai-chang.github.io/Learn_5-Day-AI-Agents-Intensive-Course-with-Google/Day1_Introduction_to_Agents/guide.html)

## Day 2 (Agent Tools & Interoperability with Model Context Protocol (MCP))
- [summary podcast](https://www.youtube.com/watch?v=Cr4NA6rxHAM)
- [課程內容](https://www.kaggle.com/whitepaper-agent-tools-and-interoperability-with-mcp)
- [Chiakai 產的 AI 簡報+備忘稿](https://chiakai-chang.github.io/Learn_5-Day-AI-Agents-Intensive-Course-with-Google/Day2_Agent_Tools_and_MCP/guide.html)

## Day 3 (Context Engineering: Sessions & Memory)
- [summary podcast](https://www.youtube.com/watch?v=FMcExVE15a4)
